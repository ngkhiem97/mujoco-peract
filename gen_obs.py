...
top_camera_extrinsics    = [[ 1,    0,    0,    0.13],
                          [ 0,   -1,    0,    0   ],
                          [ 0,    0,   -1,    2.1],
                          [ 0,    0,    0,    1.  ]]
...
side_1_camera_extrinsics = [[ 1.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.30000000e-01],
                            [ 0.00000000e+00, -7.96326711e-04, -9.99999683e-01,  1.50000000e+00],
                            [ 0.00000000e+00,  9.99999683e-01, -7.96326711e-04,  1.12000000e+00],
                            [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]]
side_2_camera_extrinsics = [[-9.99998732e-01,  1.59265292e-03,  2.16840434e-19,  1.30000000e-01],
                            [ 1.26827206e-06,  7.96325701e-04,  9.99999683e-01, -1.50000000e+00],
                            [ 1.59265241e-03,  9.99998415e-01, -7.96326711e-04,  1.12000000e+00],
                            [ 0.00000000e+00,  0.00000000e+00,  0.00000000e+00,  1.00000000e+00]]

top_camera_intrinsics = [[171.17577561,   0,         212],
                         [  0,         171.17577561, 120],
                         [  0,           0,            1]]
front_camera_intrinsics = [[171.17577561,   0,         212],
                           [  0,         171.17577561, 120],
                           [  0,           0,            1]]
side_1_camera_intrinsics = [[171.17577561,   0,         212],
                            [  0,         171.17577561, 120],
                            [  0,           0,            1]]
side_2_camera_intrinsics = [[171.17577561,   0,         212],
                            [  0,         171.17577561, 120],
                            [  0,           0,            1]]
...
import pickle
with open("data/episode1/obs.pkl", "wb") as f:
    pickle.dump(obs, f)